...
export const discordGeminiBot = {
  ...
  studyNotes: [
    ...
    },
    {
      ...
      paragraphs: ['token_tracker.py는 API 호출과 검색 사용 횟수를 날짜별로 기록하고 상태·경고 정보를 제공합니다. 이름과 달리 모델의 입력·출력 토큰 개수 대신 호출 횟수를 관리하는 구성입니다.', '이 글은 2025년 11월 13일 커밋 74cca40의 코드를 기준으로 기능과 구조를 정리했습니다. 모델 이름은 해당 코드에 지정된 값이며, TTS 설명은 Edge TTS를 사용하는 구현을 기준으로 작성했습니다.'],
